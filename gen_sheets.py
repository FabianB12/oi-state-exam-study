...
# ============================== SHEET 2 ==============================
col1_2 = r'''        <section>
          <h2><span class="n">1</span>Delete relaxation <dfn class="tip" tabindex="0" data-tip="Π names the planning task itself (Π = (F,A,I,G), sheet 1). Π⁺ is that same task with every delete list emptied — still a task, not a heuristic. The heuristic is h⁺: the optimal cost of solving Π⁺.">\( \Pi^+ \)</dfn> <span class="say">open with this!</span></h2>
        ...
        <section>
          ...
          <p class="intro"><span class="say-lead">say:</span> “First compute, for every single fact, how much it costs to achieve in the relaxed task. Then the goal has several facts — hmax prices it by its most expensive one, hadd just adds them all up.”</p>
          <ul>
